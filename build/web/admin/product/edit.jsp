                    ...
                    <div class="row g-4">
                            ...
                            <div class="bg-light rounded h-100 p-4">
                                ...
                                <!--                                <form action="EditProductServlet" method="post">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input name="name" value="${product.name}" type="name" class="form-control" id="exampleInputName"
                                                                               aria-describedby="emailHelp">
                                                                    </div>
                                                                    <div class="mb-3">
                                                                        <label for="exampleInputEmail1" class="form-label">description</label>
                                                                        <textarea name="description" type="description" value="${product.description}" class="form-control" id="exampleInputName"
                                                                                  aria-describedby="emailHelp"> </textarea>
                                                                    </div>
                                                                    <div class="mb-3">
                                                                        <label for="exampleInputEmail1" class="form-label">thumbnail</label>
                                                                        <input name="thumbnail" type="thumbnail" value="${product.thumbnail}" class="form-control" id="exampleInputName"
                                                                               aria-describedby="emailHelp">
                                                                    </div>
                                                                    <div class="mb-3">
                                                                        <label for="exampleInputEmail1" class="form-label">price</label>
                                                                        <input name="price" type="price"  value="${product.price}" class="form-control" id="exampleInputName"
                                                                               aria-describedby="emailHelp">
                                                                    </div>
                                                                    <div class="mb-3">
                                                                        <label for="exampleInputEmail1" class="form-label">quantity</label>
                                                                        <input name="quantity" type="quantity" value="${product.quantity}" class="form-control" id="exampleInputName"
                                                                               aria-describedby="emailHelp">
                                                                    </div>
                                                                    <div class="mb-3">
                                                                        <label class="form-check-label" for="roleSelect">Category</label>
                                                                        <select name="categoryId" class="form-control">
                                <c:forEach items="${categoryList}" var="category">
                                    <option <c:if test="${category.id == product.categoryId}">accesskey</c:if> value="${category.id}">${category.name}</option>
                                </c:forEach>
                            </select>
                        </div>
                        ...
                        <button type="submit" class="btn btn-primary">Add Category</button>
                                ...
                                <form action="EditProductServlet" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        <label for="thumbnail" class="form-label">Thumbnail (Leave blank if you don't want to change)</label>
                                        <input name="thumbnail" type="file" class="form-control" id="thumbnail">
                                    </div>
                                    <div class="mb-3">
                                        <label for="price" class="form-label">Price</label>
                                        <input name="price" type="number" step="0.01" value="${product.price}" class="form-control" id="price" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="quantity" class="form-label">Quantity</label>
                                        <input name="quantity" type="number" value="${product.quantity}" class="form-control" id="quantity" required>
                                    </div>
                                    <div class="mb-3">
