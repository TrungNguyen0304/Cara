                            ...
                            <div class="bg-light rounded h-100 p-4">
                                ...
                                <form action="EditCategoryServlet" method="post">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input name="name" type="name" value="${category.name}" class="form-control" id="exampleInputEmail1"
                                               aria-describedby="emailHelp">
                                        <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div>
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputPassword1" class="form-label">Password</label>
                                        <input name="thumbnail" type="thumbnail" value="${category.thumbnail}"  class="form-control" id="exampleInputPassword1">
                                    </div>
