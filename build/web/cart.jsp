                                                                                                ...
                                                                                                <td class="tf-cart-item_product">
                                                                                                    ...
                                                                                                    <div class="cart-info">
                                                                                                        ...
                                                                                                        <form action="CartServlet" method="post">
                                                                                                            ...
                                                                                                            <button type="submit" class="fa-regular fa-circle-xmark">Remove</button>
                                                                                                        </form>

                                                                                                    </div>
                                                                                                </td>
                                                                                                <td class="tf-cart-item_price" cart-data-title="Price">
                                                                                                    <div class="cart-price">$${orderItem.price}</div>
                                                                                                </td>
                                                                            ...
                                                                            <div class="tf-page-cart-footer">
                                                                                <div class="tf-cart-footer-inner">
                                                                                    ...
                                                                                    <div class="tf-page-cart-checkout">
                                                                                        ...
                                                                                        <p class="tf-cart-tax">
                                                                                            <form action="QRCodeGeneratorServlet" method="post" target="qrFrame">
                                                                                                <input type="submit" value="Generate Payment QR Code">
                                                                                            </form>
                                                                                            <iframe name="qrFrame" style="border:none; width:300px; height:200px; margin-left: 100px"></iframe>
                                                                                        </p>
