<%-- 
    Document   : sidebar
    Created on : 14 Sept 2024, 10:45:56 pm
    Author     : asus
--%>
        ...
        <div class="navbar-nav w-100">
            <a href="DashboardServlet" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
             <div class="nav-item dropdown">
                <a href="" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-th me-2"></i>Users</a>
            ...
            <div class="nav-item dropdown">
             ...
             <div class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-table me-2"></i></i>Products</a>
                <div class="dropdown-menu bg-transparent border-0">
